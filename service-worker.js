...
const CACHE_NAME = 'chinese-study-v25';
const PRECACHE_URLS = [
  './',
  './index.html',
  ...
  './data/hsk3/lessons/lesson-01.js',
  './data/hsk3/lessons/lesson-02.js',
  './data/hsk3/lessons/lesson-03.js',
  './data/hsk3/lessons/lesson-04.js',
  './data/hsk3/lessons/lesson-05.js',
  './data/hsk3/lessons/lesson-06.js',
  './data/hsk3/lessons/lesson-07.js',
  './data/hsk3/lessons/lesson-08.js',
  './data/hsk3/lessons/lesson-09.js',
  './data/hsk3/lessons/lesson-10.js',
  './data/hsk3/lessons/lesson-11.js',
  './data/hsk3/lessons/lesson-12.js',
  './data/hsk3/lessons/lesson-13.js',
  './data/hsk3/lessons/lesson-14.js',
  './data/hsk3/lessons/lesson-15.js',
  './data/hsk3/lessons/lesson-16.js',
  './data/hsk3/lessons/lesson-17.js',
  './data/hsk3/lessons/lesson-18.js',
  './data/hsk3/lessons/lesson-19.js',
  './data/hsk3/lessons/lesson-20.js',
  './data/hsk3/grammar/lesson-01.js',
  './data/hsk3/grammar/lesson-02.js',
  './data/hsk3/grammar/lesson-03.js',
  './data/hsk3/grammar/lesson-04.js',
  './data/hsk3/grammar/lesson-05.js',
  './data/hsk3/grammar/lesson-06.js',
  './data/hsk3/grammar/lesson-07.js',
  './data/hsk3/grammar/lesson-08.js',
  './data/hsk3/grammar/lesson-09.js',
  './data/hsk3/grammar/lesson-10.js',
  './data/hsk3/grammar/lesson-11.js',
  './data/hsk3/grammar/lesson-12.js',
  './data/hsk3/grammar/lesson-13.js',
  './data/hsk3/grammar/lesson-14.js',
  './data/hsk3/grammar/lesson-15.js',
  './data/hsk3/grammar/lesson-16.js',
  './data/hsk3/grammar/lesson-17.js',
  './data/hsk3/grammar/lesson-18.js',
  './data/hsk3/grammar/lesson-19.js',
  './data/hsk3/grammar/lesson-20.js',
  './data/pinyin-data.js',
  './js/storage.js',
  './js/speech.js',
  './js/recorder.js',
