      ...
      blocks: [
        {
          ...
          examples: [
            { raw: '你的汉语怎么样？', speak: '你的汉语怎么样？', pinyin: 'Nǐ de Hànyǔ zěnmeyàng?', en: "How's your Chinese?" },
            { raw: '你妈妈身体怎么样？', speak: '你妈妈身体怎么样？', pinyin: 'Nǐ māma shēntǐ zěnmeyàng?', en: "How's your mother's health?" },
            { raw: '明天天气怎么样？', speak: '明天天气怎么样？', pinyin: 'Míngtiān tiānqì zěnmeyàng?', en: 'What will the weather be like tomorrow?' },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          examples: [
            { raw: '太热了。', speak: '太热了。', pinyin: 'Tài rè le.', en: "It's too hot." },
            { raw: '天气太冷了。', speak: '天气太冷了。', pinyin: 'Tiānqì tài lěng le.', en: 'The weather is too cold.' },
            { raw: '我身体不太好。', speak: '我身体不太好。', pinyin: 'Wǒ shēntǐ bú tài hǎo.', en: "I'm not feeling too well." },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          examples: [
            { raw: 'A: 爸爸八点前会回家吗？ B: 会。', speak: '爸爸八点前会回家吗？会。', pinyin: 'A: Bàba bā diǎn qián huì huí jiā ma? B: Huì.', en: 'Will dad be home before eight? Yes.' },
            { raw: 'A: 明天她会来吗？ B: 她会来。', speak: '明天她会来吗？她会来。', pinyin: 'A: Míngtiān tā huì lái ma? B: Tā huì lái.', en: 'Will she come tomorrow? She will come.' },
            { raw: 'A: 今天会下雨吗？ B: 今天不会下雨。', speak: '今天会下雨吗？今天不会下雨。', pinyin: 'A: Jīntiān huì xià yǔ ma? B: Jīntiān bú huì xià yǔ.', en: "Will it rain today? It won't rain today." },
          ],
        },
      ],
    },
