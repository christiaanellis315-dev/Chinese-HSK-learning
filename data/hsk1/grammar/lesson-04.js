...
Books.registerGrammar('hsk1', '4', [
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          examples: [
            { raw: '哪本 (běn, a measure word for books) 书 (shū, book)？', speak: '哪本书？', pinyin: 'Nǎ běn shū?', en: 'Which book?' },
            { raw: '哪个 (gè, a general measure word) 人？', speak: '哪个人？', pinyin: 'Nǎge rén?', en: 'Which person?' },
            { raw: '你是哪国人？', speak: '你是哪国人？', pinyin: 'Nǐ shì nǎ guó rén?', en: 'Which country are you from?' },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          examples: [
            { raw: '李月是我的老师。', speak: '李月是我的老师。', pinyin: 'Lǐ Yuè shì wǒ de lǎoshī.', en: 'Li Yue is my teacher.' },
            { raw: '这 (zhè, this) 是我的书 (shū, book)。', speak: '这是我的书。', pinyin: 'Zhè shì wǒ de shū.', en: 'This is my book.' },
            { raw: '她不是我同学，她是我朋友。', speak: '她不是我同学，她是我朋友。', pinyin: 'Tā bú shì wǒ tóngxué, tā shì wǒ péngyou.', en: "She isn't my classmate, she's my friend." },
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          examples: [
            { raw: '我不是老师，我是学生。你呢？', speak: '我不是老师，我是学生。你呢？', pinyin: 'Wǒ bú shì lǎoshī, wǒ shì xuésheng. Nǐ ne?', en: "I'm not a teacher, I'm a student. What about you?" },
            { raw: '她叫李月。他呢？', speak: '她叫李月。他呢？', pinyin: 'Tā jiào Lǐ Yuè. Tā ne?', en: 'Her name is Li Yue. What about him?' },
            { raw: '我是美国人。你呢？', speak: '我是美国人。你呢？', pinyin: 'Wǒ shì Měiguó rén. Nǐ ne?', en: "I'm American. What about you?" },
          ],
        },
      ],
    },
